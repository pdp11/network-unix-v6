...
#define IEXCLU  0200            /* rand:greep--open for exclusive access */
...
#define	IWRITE	0200
#define	IEXEC	0100
#define IEXOPN     0            /* rand:greep--used when open1 calls access */
#define IPIPE	01		/* bbn:mek---used to signal delayed writes
						for ports and pipes */
