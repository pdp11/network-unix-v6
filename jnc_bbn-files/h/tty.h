 ...
 *
 * Modified 12/28/77 to add t_itp pointer to await (BBN: jfh)
 *
 */
struct tty
{
	...
	char    *t_itp;         /* pointer to itab entry, or 0 */
};
...
#define DELIMITER 0376
/* DELIMITER is inserted by ttyinput after each break char */
...
#define XONXOFF 006000          /* tab delay type 3 => XON/XOFF */
...
#define XOFFHNG 0200            /* Stopped waiting for XON */
