...
#ifdef UCBUFMOD
	int	b_paddr;		/* physical address/64 of the buffer */
#endif
 ...
 * so we can get away with using a devtab.
 */
#ifdef NBUF
struct	devtab bfreelist;
#endif NBUF
...
#define B_KERN	04000	/* data address is in the kernel */
