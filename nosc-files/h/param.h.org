...
#define CPU40		/* CPU must be 40 or 45 */
...
#define NDH11	12	/* we support 12 DH lines */
#define NPTY	4	/* we support 4 psuedo-ttys */
#define SPINPID		/* spin process IDs so less overlap */
