 ...
 *
 * When adding new system calls to UNIX be sure to recompile
 * the debuggers and add the necessary new information.
 *
 * ddt: change syscall.h  to include the new information
 * db:
 * cdb:
 */
int	sysent[]
