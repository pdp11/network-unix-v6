...
int dcrstab[] {
	...
	0,		/* 75 baud */
	0101,		/* 110 baud */
	0111,		/* 134.5 baud: 7b/ch, speed 0 */
	0121,		/* 150 baud: 8b/ch, speed 1 */
	0,		/* 200 baud */
	0131,		/* 300 baud: 8b/ch, speed 2 */
	0,		/* 600 baud */
	0,		/* 1200 baud */
	0,		/* 1800 baud */
	0,		/* 2400 baud */
...
dcopen(dev, flag)
{
	...
	if ((tp->t_state&ISOPEN) == 0) {
		tp->t_erase = CERASE;
		tp->t_kill = CKILL;
		addr->dcrcsr = IENABLE|CDLEAD|SPEED3;
		addr->dctcsr = IENABLE|SPEED3|STOP1|RQSEND;
